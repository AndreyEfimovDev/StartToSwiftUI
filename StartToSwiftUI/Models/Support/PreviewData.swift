...
extension PreviewData {
    ...
    static let sampleSnippet1 = CodeSnippet(
        id: "snippet_001",
        category: "SwiftUI",
    ...
    static let sampleSnippet2 = CodeSnippet(
        id: "snippet_002",
        category: "SwiftUI",
        title: "Async Image with Placeholder",
        intro: "Loads a remote image asynchronously with a shimmer placeholder while it downloads.",
        codeSnippet: """
        ...
        """,
        origin: .cloud,
        date: Date.from(year: 2025, month: 10, day: 5) ?? Date(),
        addedDateStamp: .now
    )

    static let sampleSnippet3 = CodeSnippet(
        id: "snippet_003",
        category: "SwiftUI",
        title: "Debounced Search with Combine",
        intro: "Applies a 0.5s debounce to a search field using Combine, avoiding excessive filtering on every keystroke.",
        codeSnippet: """
        $searchText
        ...
        """,
        origin: .local,
        date: Date.from(year: 2026, month: 1, day: 20) ?? Date(),
        addedDateStamp: .now
    )
}
