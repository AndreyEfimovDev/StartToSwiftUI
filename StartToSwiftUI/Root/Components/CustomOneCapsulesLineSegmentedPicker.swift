...
struct CapsulesSegmentedPicker<T: Hashable>: View {
...
fileprivate struct CustomOneCapsulesLineSegmentedPickerPreview: View {
    ...
    @OptionalAppStorage("themePrewView") private var theme: Theme?
...
fileprivate struct CustomOneCapsulesLineSegmentedPickerPreview2: View {
    ...
    @OptionalAppStorage("selectedForPreview") var selectedForPreview: String?
